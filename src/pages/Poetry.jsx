...
const Poetry = () => {
    ...
    const allTitles = poems.length > 0 ? poems : Array(12).fill(BOOKS).flat().slice(0, 12);
    ...
    return (
        <div className="pb-20 pt-10">
            ...
            <header className="container mb-12 text-center">
                ...
                >
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">Poetry</span>
                </h1>
            </header>
            ...
            <section className="container">
                ...
                <div className="flex items-center gap-2">
                    <h2 className="text-2xl font-bold text-white">Trending Poetry in {activeCategory}</h2>
            ...
            <section className="container">
                <div className="flex items-center gap-2">
                    <h2 className="text-2xl font-bold text-white">All Poetry</h2>
