        ...
        <div className="pb-40 pt-10">
            ...
            <div className="container max-w-3xl mx-auto">
                ...
                <article className="mb-4">
                    <h2 className="text-3xl font-bold text-white pl-6 border-l-4 border-red-500" style={{ marginBottom: '10px' }}>The Problem</h2>
                    <div className="pl-6 text-lg text-zinc-300 space-y-4 leading-relaxed" style={{ marginBottom: '16px' }}>
                        <p>
                            Social media is broken. Even though people follow you, platforms limit your reach to just 1% to 3% of your audience. They intentionally hide your work from your own friends and family to force you to pay for "boosted" posts. Today, you have to pay Mr. Zuckerberg just to be heard.
                        </p>
                    </div>
                </article>
                ...
                <article className="mb-4">
                    ...
                    <div className="pl-6 text-lg text-zinc-300 space-y-4 leading-relaxed" style={{ marginBottom: '16px' }}>
                        <p>
                            <strong>Syndicate</strong> is a content syndication platform designed to solve the discovery problem faced by most creators. We allow creators to share their art directly with their friends, family, and fans. It's Creators first. We believe in <span className="text-[#cc5500] font-bold">direct affinity</span> between the artist and the audience.
                        </p>
                    </div>
                </article>
                ...
                <article className="mb-4">
                    ...
                    <div className="pl-6 text-lg text-zinc-300 space-y-4 leading-relaxed" style={{ marginBottom: '16px' }}>
                        <p>
                            Syndicate was founded by <strong>Michael James</strong>, an author and geek. James created the platform after his own experience publishing <em>Tyger: A Story of Survival</em> (4.4 stars on Amazon). His personal frustrations with the difficulty of gaining visibility for his work on major platforms led him to build a solution that empowers creators to own their distribution.
                        </p>
                    </div>
                </article>
                ...
                <article>
                    ...
                    <div className="pl-6 text-lg text-zinc-300 space-y-4 leading-relaxed">
                        ...
                        <ul className="list-disc space-y-2 text-zinc-400" style={{ paddingLeft: '40px' }}>
                            ...
                            <li><strong>Direct Support:</strong> Readers make voluntary contributions which go directly to the creator's account (minus a small flat service fee).</li>
                        </ul>
                    </div>
                </article>
